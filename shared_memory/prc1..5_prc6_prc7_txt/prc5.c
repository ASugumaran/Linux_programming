...
char string1[]="string 15 through msgqueue\n";
...
int main()
{
   ...
   //create msgqueue using key 1005
   ...
   // 15 is msg number
   msg_buffer.mtype = 15; // 15 is msg number
   size = strlen(string1)+1;

   //flag is 0,as no flag is set
   //msgsnd = to send mesages to a system V messagequeue
